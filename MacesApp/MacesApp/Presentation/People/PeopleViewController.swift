...
class PeopleViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        viewModel = PeopleViewModel(peopleRepository: PeopleRepository(networkManager: NetworkManager()))
        
        viewModel?.submitAction(action: .loadPeoples(ApiRequest(baseUrl: EndPoint.baseUrl, path: Path.people, params: [:])))
